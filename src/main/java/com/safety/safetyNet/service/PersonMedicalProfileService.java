 ...
 * 
 * public PersonMedicalProfileService(PersonService personService,
 ...
 * 
 * // GET Combiné
 * public Optional<Person> getPersonWithMedicalRecord(String firstName) throws
 * Exception {
 * Optional<Person> personOpt = personService.getPersonByFirstName(firstName);
 * if (personOpt.isPresent()) {
 * Optional<MedicalRecord> medOpt =
 * medicalRecordService.getMedicalRecordByFirstName(firstName);
 * medOpt.ifPresent(personOpt.get()::setMedicalRecord); /// Ajout du
 * medicalRecord à la personne
 * }
 * return personOpt;
 * }
 * 
 ...
 * 
 * // PUT
 * public boolean updatePersonWithMedicalRecord(String firstName, Person
 * updatedPerson) throws Exception {
 ...
 * medUpdated = medicalRecordService.updateMedicalRecord(firstName,
 * updatedPerson.getMedicalRecord());
 * }
 * return personUpdated && medUpdated;
 * }
 * 
 * // DELETE
 * public boolean deletePersonWithMedicalRecord(String firstName) throws
 * Exception {
