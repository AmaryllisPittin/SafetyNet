...
public class JsonReaderTests {
    ...
    void InitDataFileCreatesFile() throws IOException {
        ...
        if (file.exists())
            file.delete();
        JsonReader.initDataFile();
        assertTrue(file.exists());
    }

    @Test
    void WritePersonsPersistData() throws IOException {
        List<Person> persons = List.of(new Person("Kendrik", "Stelzer", "947 E. Rose Dr", "Culver", "97451",
    ...
    void WriteMedicalRecordsPersistData() throws IOException {
        List<MedicalRecord> medicalRecords = List.of(new MedicalRecord("John", "Boyd", "03/06/1984",
        ...
        assertEquals(medicalRecords.get(0).getFirstName(), readBack.get(0).getFirstName());
    }

    @Test
    void WriteFireStationsPersistData() throws Exception {
        List<FireStation> fireStations = List.of(new FireStation("951 LoneTree Rd", "2"));
